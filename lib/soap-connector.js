...
function SOAPConnector(settings) {
  ...
  // var self = this;
  // console.log('binding' , this.settings , settings)
...
SOAPConnector.prototype._invoke = function(opts, cb) {
  console.log('_invoke ' , this.settings ,opts);
  var self = this;
  var headers = extend(this.settings.headers, opts.headers);
  var options = extend(this.settings.options, opts.options);
  soap.createClient(this.settings.wsdl || opts.wsdl,{wsdl_headers: headers, options:options},function(e, client) {
    if (e) {
